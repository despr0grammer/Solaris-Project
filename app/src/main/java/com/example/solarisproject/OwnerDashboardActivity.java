...
public class OwnerDashboardActivity extends AppCompatActivity {
    ...
    private TextView textViewPowerGenerated;
    private TextView textViewEnergyAccumulated;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewPowerGenerated = findViewById(R.id.textView_power_generated);
        textViewEnergyAccumulated = findViewById(R.id.textView_energy_accumulated);
        textViewEfficiency = findViewById(R.id.textView_efficiency);

        // Inicializar Line Chart
        lineChart = findViewById(R.id.lineChart);
        setupLineChart();

        // Inicializar RecyclerView para Alertas
    ...
    private void setLineChartData() {
        ...
        LineDataSet lineDataSet = new LineDataSet(entries, "Producción de Energía");
    ...
    private void generateDummyAlerts() {
        ...
        alertList.add(new Alert("Batería baja", "La batería del panel 2 está baja.", "Media", getResources().getColor(android.R.color.holo_orange_light)));
        alertList.add(new Alert("Mantenimiento", "Se requiere mantenimiento en el panel 1.", "Baja", getResources().getColor(android.R.color.holo_green_light)));
    ...
    private void simulateRealTimeData() {
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                textViewPowerGenerated.setText("Potencia Generada: " + random.nextInt(500) + "W");
                textViewEnergyAccumulated.setText("Energía Acumulada: " + random.nextInt(1000) + "Wh");
                textViewEfficiency.setText("Eficiencia del Sistema: " + random.nextInt(100) + "%");
